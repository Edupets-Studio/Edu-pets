...
function generarPregunta() {
  ...
  if (preguntas >= totalPreguntas) {
    mensajeDiv.innerHTML = '<div class="message success">¡Excelente trabajo! Terminaste todas las multiplicaciones.</div>';
    aumentarOrbeSiCoincide("multiplicacion");
  ...
  const respuesta = a * b;
  document.getElementById("titulo").textContent = `Multiplicación: ejercicios con ${a}`;
